        ...
        <form action="{{route('order.store')}}" method="POST" autocomplete="off">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="number" value="{{ old('number') }}" class="form-control" placeholder="Auto Generate" readonly />
                </div>
                <div class="form-group">
                    <label>User</label>
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        ...
                        <input type="number" min="0" step="1" name="stock" id="stock" class="form-control" readonly>
                    </div>
                    <div class="col-3">
                        <label for="price">Price</label>
                        <input type="number" min="0" step="1" name="price" id="price" class="form-control" placeholder="Enter price" readonly>
                    </div>
                    <div class="col-2">
                        <label for="qty">Qty</label>
                        <input type="number" min="1" step="1" name="qty" id="qty" class="form-control" placeholder="Enter qty">
                    </div>
                    <div class="col-2">
                ...
                <hr>
                <table class="table table-bordered table-checkable" id="table-order-detail">
                    <thead>
                        <tr>
                            <td></td>
                            <td>Product</td>
...
@push('new-script')
    ...
    <script>
        ...
        async function onAddItem(event){
            ...
            let dataStock = $('#stock').val()
            let dataQty = $('#qty').val()
            let dataPrice = $('#price').val()

            if(dataProduct === "" || dataQty == "" || dataQty == 0 || dataPrice == ""){
                swal(
                    'Information',
            ...
            if(parseInt(dataStock) < parseInt(dataQty)){
                swal(
                    'Information',
                    'Quantity exceeds the existing stock',
                    'error'
                )
                event.preventDefault()
            }
            ...
            $('#table-order-detail tbody').append(`
                <tr>
